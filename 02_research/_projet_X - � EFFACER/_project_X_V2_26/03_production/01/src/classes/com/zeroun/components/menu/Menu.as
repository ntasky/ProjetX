package com.zeroun.components.menu
{
	...
	public class Menu extends Sprite
	{
		...
		public function Menu(	__data:XML,
								...
								__itemSpacingY:int = ITEM_SPACING_Y)
		{
			...
			for each (var data:XML in __data.page)
			{
				if (data.@id.split("/").length == 3 && data.@show_in_menu == "1") _addItem(data, _data.page.(@id.search(data.@id) == 0 && @id != data.@id && @show_in_menu == "1"));
			}
		}
