package com.zeroun.components.samples
{
	...
	public class ComponentsSamples extends MovieClip
	{
		...
		private var _loadinganimation	:LoadingAnimationRoundStyle;
		...
		public function ComponentsSamples()
		{
			...
			_loadinganimation = new LoadingAnimationRoundStyle(LoadingAnimationRoundStyleElement);
			_loadinganimation.x = 600;
			_loadinganimation.y = 600;
			...
			_menu = new Menu(dataXML, RollDownMenuItem, "", 100, 0);
			//_menu = new Menu(dataXML, SimpleMenuItem, "", 100, 0);
			_menu.x = 10;
			_menu.y = 10;
