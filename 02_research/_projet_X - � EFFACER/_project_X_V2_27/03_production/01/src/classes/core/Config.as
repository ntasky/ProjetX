package core
{
	public class Config
	{
		...
		public static const MULTI_LANGUAGE					:Boolean = true;		// set to true if languages tag are used in the XML
		...
		public static const LOCAL_ASSETS_BASE_PATH			:String = "../../00_assets/";
