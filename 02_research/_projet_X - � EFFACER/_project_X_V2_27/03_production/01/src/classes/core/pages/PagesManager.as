package core.pages
{
	...
	public class PagesManager extends Sprite
	{
		...
		{
			if (Config.DEBUG_MODE) traceDebug("_onChangePage>>" + __pageId + " language:" + __language);
		...
		private function _revealPage(__pageId:String):void
		{
			...
			if (_pagesById[_currentPageId] == null )
			{
				_pagesById[_currentPageId] = new GenericPage(_currentPageId);
			}
