package com.zeroun.utils 
{
    ...
    public class SWFAddresses {
		...
		// :NOTE: this function works only when the URL is formed like this : #/$locale/PAGE_ID/[SUBPAGE_ID/...] otherwise use native function SWFAddress.getValue();
		...
		public static function getSWFAddressLocale():String
		{
