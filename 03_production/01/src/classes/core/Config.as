package core
{
	public class Config
	{
		...
		public static const DEBUG_ALLOWED_URLS				:Array = ["http://127.0.0.1/", "http://dev.zero-un.com/", "http://client.zero-un.com/"];	// list of urls where debugging is allowed (DebugWindow will not appear unless root.loaderInfo.url begins with one of these addreses)
